...
class JSON extends Field
{
    ...
    {
        $this->fields->each(function ($field) use ($request, $model, $attribute, $requestAttribute) {
            $field->fillInto($request, $model, $attribute . '->' . $field->attribute, $requestAttribute . '.' . $field->attribute);
        });
    }
